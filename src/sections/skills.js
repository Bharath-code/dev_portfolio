...
import { renderSkillRadar } from "../modules/skill-radar.js";

export const renderSkills = (skills, matrix) => {
	...
	try {
		renderSkillRadar(matrix);
	} catch (error) {
		console.error("Failed to render skill radar", error);
	}
};
